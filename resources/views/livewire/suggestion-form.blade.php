<form wire:submit="save" class="flex flex-col items-center flex flex-col items-center mx-3 lg:mx-5 ">
    ...
    <div
        class="flex flex-col bg-white/50 gap-5 mb-20 pb-5 items-center pt-5 w-full px-5 rounded-tr-lg rounded-l-lg rounded-br-lg shadow items-start">
